export function HeroSection() {
  return (
    <div className="flex flex-col items-start py-20">
      ...
      <button className="rounded-xl flex items-center justify-center px-4 py-1 text-center transition duration-150 focus:outline-none text-lg disabled:cursor-not-allowed uppercase font-bold text-white border-2 border-white">
        FALE CONOSCO
      </button>
    </div>
  )
